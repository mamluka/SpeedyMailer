...
(function(a) { a.VK = { DELETE: 46, BACKSPACE: 8, ENTER: 13, TAB: 9, SPACEBAR: 32, UP: 38, DOWN: 40 }; })(tinymce);
(function(k) {
    ...
    function b(m) {
        m.dom.bind(m.getDoc(), "focusin", function() { m.selection.setRng(m.selection.getRng()); });
    }
...
tinymce.html.Styles = function(d, f) {
    ...
    return {
        ...
        parse: function(r) {
            ...
            function i(B, A) {
                if (q) {
                    B = B.replace( /\uFEFF[0-9]/g , function(C) { return a[C]; });
                }
                if (!A) {
                    B = B.replace( /\\([\'\";:])/g , "$1");
                }
...
(function(m) {
    ...
    function a(r, q) {
        ...
        function n(s) {
            return s.replace( /[A-Z]+/g , function(t) { return n(r[t]); });
        }
...
(function(m) {
    ...
    m.create("tinymce.Editor", {
        ...
        init: function() {
            ...
            if (I.content_css) {
                m.each(g(I.content_css), function(s) { H.contentCSS.push(H.documentBaseURI.toAbsolute(s)); });
            }
        ...
        setupIframe: function() {
            ...
            if (v.handle_node_change_callback) {
                q.onNodeChange.add(function(t, s, z) { q.execCallback("handle_node_change_callback", q.id, z, -1, -1, true, q.selection.isCollapsed()); });
            }
            if (v.save_callback) {
            ...
            if (v.onchange_callback) {
                q.onChange.add(function(t, s) { q.execCallback("onchange_callback", q, s); });
            }
            if (v.protect) {
                q.onBeforeSetContent.add(function(s, t) {
                    if (v.protect) {
                        i(v.protect, function(z) { t.content = t.content.replace(z, function(A) { return "<!--mce:protected " + escape(A) + "-->"; }); });
                    }
                });
            }
            ...
            if (v.padd_empty_editor) {
                q.onPostProcess.add(function(s, t) { t.content = t.content.replace( /^(<p[^>]*>(&nbsp;|&#160;|\s|\u00a0|)<\/p>[\r\n]*|<br \/>[\r\n]*)$/ , ""); });
            }
            if (a) {
...
(function(c) {
    ...
    c.EditorCommands = function(n) {
        ...
        u({
            "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull": function(v) { return t("align" + v.substring(7)); },
            ...
            "InsertUnorderedList,InsertOrderedList": function(v) { return m.getParent(p.getNode(), v == "insertunorderedlist" ? "UL" : "OL"); }
        }, "state");
        u({
...
(function(a) {
    a.Formatter = function(U) {
        ...
        function S(Y, ag, ab) {
            ...
            function V(al, ak) {
                ...
                if (al) {
                    ...
                    O(ak.styles, function(an, am) { c.setStyle(al, am, r(an, ag)); });
                    O(ak.attributes, function(an, am) { c.setAttrib(al, am, r(an, ag)); });
            ...
            function X(an, at, aq, ap, al) {
                ...
                if (am <= 0 || (av < am && ao > am)) {
                    ...
                    ap.push(au);
                    O(ak, function(aw) { au.appendChild(aw); });
                    return au;
                }
            }
        ...
        function j(X, Z, Y) {
            ...
            function V(aa) {
                aa = c.getParent(aa, function(ab) { return !!x(ab, X, Z, true); });
                return x(aa, X, Z);
            }
        ...
        function r(V, W) {
            if (typeof(V) != "string") {
                ...
                if (W) {
                    V = V.replace( /%(\w+)/g , function(Y, X) { return W[X] || Y; });
                }
            }
            return V;
        }
        ...
        function u(Z, Y) {
            ...
            if (Z && Y) {
                ...
                if (ab(Z, Y)) {
                    ...
                    c.remove(Y);
                    O(a.grep(Y.childNodes), function(ac) { Z.appendChild(ac); });
                    return Z;
                }
            }
            return Y;
        ...
        function P(ae, V, ac) {
            ...
            a.each("onMouseUp onKeyUp".split(" "), function(ai) { U[ai].addToTop(function() { Y(); }); });
