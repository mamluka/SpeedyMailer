(function() {
    ...
    tinymce.create("tinymce.plugins.Lists", {
        init: function(y) {
            ...
            function H(T) {
                var U = tinymce.grep(T.parentNode.childNodes, function(X) { return X.tagName == "LI"; });
            ...
            y.addCommand("InsertUnorderedList", function() { this.applyList("UL", "OL"); }, this);
            y.addCommand("InsertOrderedList", function() { this.applyList("OL", "UL"); }, this);
            ...
            y.onKeyDown.add(function(T, U) { x = L(U); });
            y.onKeyDown.add(C);
            y.onKeyDown.add(u);
            y.onKeyDown.add(J);
            if (tinymce.isGecko) {
        ...
        process: function(y) {
            ...
            function B(t) {
                var s = tinymce.grep(t.childNodes, function(H) { return !(H.nodeName === "BR" || H.nodeName === "SPAN" && z.getAttrib(H, "data-mce-type") == "bookmark" || H.nodeType == 3 && (H.nodeValue == String.fromCharCode(160) || H.nodeValue == "")); });
                return s.length === 0;
            }
